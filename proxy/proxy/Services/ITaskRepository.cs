...
namespace proxy.Services
{
    public interface ITaskRepository
    {
        ...
        System.Threading.Tasks.Task<IEnumerable<Task>> GetAllByProject(string token, string project_id);
        System.Threading.Tasks.Task<IEnumerable<Task>> GetAllByPeriod(string token, string from, string till);
        System.Threading.Tasks.Task<IEnumerable<Task>> GetAllByProjectByPeriod(string token, string project_id, string from, string till);
